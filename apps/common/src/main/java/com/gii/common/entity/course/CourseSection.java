...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uk_course_sections_template_position",
          columnNames = {"course_template_id", "position"}),
      @UniqueConstraint(
          name = "uk_course_sections_template_slug",
          columnNames = {"course_template_id", "slug"})
    })
