...
public interface VerificationCodeRepository extends JpaRepository<VerificationCode, UUID> {
    ...
    List<VerificationCode> findLatestValidOtp(UUID userId, VerificationPurpose purpose, VerificationChannel channel, Pageable pageable);

    default Optional<VerificationCode> findLatestValidOtp(UUID userId, VerificationPurpose purpose, VerificationChannel channel) {
    ...
    AND o.createdAt >= :threshold
    """)
    long countRecentByChannelAndHash(VerificationChannel channel, String channelHash, Instant threshold);
