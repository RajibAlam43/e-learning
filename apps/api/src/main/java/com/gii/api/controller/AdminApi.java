...
public interface AdminApi {
  ...
  ResponseEntity<AdminCourseSectionResponse> createSection(
      @PathVariable UUID courseId, @RequestBody CreateSectionRequest request);
  ...
  ResponseEntity<AdminCourseSectionResponse> updateSection(
      @PathVariable UUID sectionId, @RequestBody UpdateSectionRequest request);
  ...
  ResponseEntity<AdminLessonDetailResponse> createLesson(
      @PathVariable UUID sectionId, @RequestBody CreateLessonRequest request);
  ...
  ResponseEntity<Void> reorderCourseStructure(
      @PathVariable UUID courseId, @RequestBody ReorderCourseStructureRequest request);
  ...
  ResponseEntity<AdminInstructorDetailResponse> updateInstructor(
      @PathVariable UUID instructorId, @RequestBody UpdateInstructorRequest request);
  ...
  ResponseEntity<Void> assignInstructorToCourse(
      @PathVariable UUID courseId, @RequestBody AssignInstructorToCourseRequest request);
  ...
  ResponseEntity<AdminLiveClassDetailResponse> createLiveClass(
      @PathVariable UUID courseId, @RequestBody CreateLiveClassRequest request);
  ...
  ResponseEntity<AdminLiveClassDetailResponse> updateLiveClass(
      @PathVariable UUID liveClassId, @RequestBody UpdateLiveClassRequest request);
  ...
  ResponseEntity<AdminQuizDetailResponse> createQuiz(
      @PathVariable UUID courseId, @RequestBody CreateQuizRequest request);

  @PatchMapping("/quizzes/{quizId}")
  @Operation(summary = "Update quiz")
  ResponseEntity<AdminQuizDetailResponse> updateQuiz(
      @PathVariable UUID quizId, @RequestBody UpdateQuizRequest request);
  ...
  ResponseEntity<AdminOrderDetailResponse> updateOrder(
      @PathVariable UUID orderId, @RequestBody UpdateOrderRequest request);
}
