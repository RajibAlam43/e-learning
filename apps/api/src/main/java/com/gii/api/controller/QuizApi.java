...
public interface QuizApi {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Quiz questions retrieved", content = @Content(schema = @Schema(implementation = QuizQuestionsResponse.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Attempt started", content = @Content(schema = @Schema(implementation = QuizAttemptStartResponse.class))),
            @ApiResponse(responseCode = "400", description = "Cannot start attempt - max attempts reached"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
            @ApiResponse(responseCode = "404", description = "Quiz not found")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Attempt submitted and graded", content = @Content(schema = @Schema(implementation = QuizAttemptResultResponse.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Result retrieved", content = @Content(schema = @Schema(implementation = QuizAttemptResultResponse.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
