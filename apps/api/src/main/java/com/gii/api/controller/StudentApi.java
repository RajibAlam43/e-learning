...
@Tag(name = "Student Dashboard", description = "Student dashboard, courses, orders, certificates, and live classes")
...
public interface StudentApi {
    ...
    @Operation(
            ...
            description = "Get dashboard overview with enrolled courses, progress, certificates, and upcoming live classes."
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Dashboard retrieved", content = @Content(schema = @Schema(implementation = StudentDashboardResponse.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Course details retrieved", content = @Content(schema = @Schema(implementation = StudentCourseHomeResponse.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    @Operation(
            ...
            description = "Get purchase history and order status."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Get all earned certificates."
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Certificates retrieved"),
            @ApiResponse(responseCode = "401", description = "Unauthorized")
    })
    ResponseEntity<List<StudentCertificateSummaryResponse>> getMyCertificates(Authentication authentication);
    ...
    ResponseEntity<List<StudentLiveClassSummaryResponse>> getUpcomingLiveClasses(Authentication authentication);
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Join information retrieved", content = @Content(schema = @Schema(implementation = StudentLiveClassJoinResponse.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
