...
@Tag(name = "Instructor", description = "Instructor dashboard, course management, and live class scheduling")
...
public interface InstructorApi {
    ...
    @Operation(
            ...
            description = "Get instructor overview with assigned courses, student counts, and upcoming live classes."
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Dashboard retrieved", content = @Content(schema = @Schema(implementation = InstructorDashboardResponse.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Live class created", content = @Content(schema = @Schema(implementation = InstructorLiveClassResponse.class))),
            @ApiResponse(responseCode = "400", description = "Invalid input - invalid schedule or lesson"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Live class started", content = @Content(schema = @Schema(implementation = InstructorLiveClassStartResponse.class))),
            @ApiResponse(responseCode = "400", description = "Cannot start - class not scheduled or already completed"),
            @ApiResponse(responseCode = "401", description = "Unauthorized"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Live class updated", content = @Content(schema = @Schema(implementation = InstructorLiveClassResponse.class))),
    ...
    @Operation(
            ...
            description = "Cancel/delete a scheduled live class."
    )
    @ApiResponses(value = {
