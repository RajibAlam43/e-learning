...
@Tag(
    name = "Lessons",
    description = "Lesson content, playback, and progress tracking for enrolled students")
...
public interface LessonApi {
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            ...
            content = @Content(schema = @Schema(implementation = LessonContentResponse.class))),
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Playback info retrieved",
  ...
  @Operation(
      ...
      description =
          "Get the course completion percentage across published lessons and quizzes. A quiz is"
              + " complete after it is passed.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  ResponseEntity<ResourceDownloadUrlResponse> getResourceDownloadUrl(
      @PathVariable UUID resourceId, Authentication authentication);
}
