...
public interface AuthApi {
    ...
    @Operation(
            summary = "Login user",
            description = "Login using email or phone with password. Returns JWT access token and sets refresh token in httpOnly cookie."
    )
    @ApiResponses(value = {
    ...
    ResponseEntity<AuthResponse> login(@RequestBody LoginRequest request, HttpServletResponse response);
    ...
    ResponseEntity<AuthResponse> refresh(@CookieValue("refresh_token") String refreshToken, HttpServletResponse response);

    @PostMapping("/forgot-password")
    @Operation(
            summary = "Send password reset code",
            description = "Send password reset code/link to email or phone. User must verify the code before resetting password."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            summary = "Logout user",
            description = "Logout by invalidating refresh token. Clear authenticati on cookies on client."
    )
    @ApiResponses(value = {
